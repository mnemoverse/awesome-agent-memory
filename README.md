...
- [Memento](https://mementoagi.com) - Hosted MCP memory for coding agents. Readable markdown graph, keyword + semantic + graph recall, team-shared orgs, web dashboard. Works with Cursor, Claude Code, and other MCP clients. Not the abandoned gannonh/memento-mcp Neo4j server.
